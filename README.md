# Graveyard Keeper 2 — Launch Guide Site

This is the launch-week guide hub for **Graveyard Keeper 2** (Lazy Bear Games, Steam AppID 4358690), built from the V3 game-guide-site-template by the `one-click-builder` role. It provides
