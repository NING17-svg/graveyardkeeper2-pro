...
export const earlyAccessPage: PageContent = {
  ...
  pageType: "release",
  presentation: { shell: "content", variant: "reading-right-rail" },
  h1: "Graveyard Keeper 2 Demo Saves and Early Access Launch Status",
  seoTitle: "Graveyard Keeper 2 Demo Save Carry-Over and Full Launch Status",
  metaDescription:
    "Yes. The September 14-22, 2026 public demo saves carry over to Graveyard Keeper 2 on the same platform and account. Here is how to keep progress before the demo is removed.",
  summary:
    "Demo saves carry over to the full release on the same platform and account (tinyBuild and Lazy Bear Games, confirmed across press coverage). The game still ships as a full launch on September 22, 2026 with no separate Steam Early Access phase.",
  hero: {
    eyebrow: "Demo save carry-over",
    subtitle: "Demo progress transfers to the full release on the same platform and account; the demo client is removed on launch day.",
    ctas: [
      { label: "Release timing", href: "/release/" },
      { label: "Editions and pricing", href: "/editions/" },
  ...
  quickAnswer:
    "Yes. tinyBuild and Lazy Bear Games confirmed that public demo saves carry over to Graveyard Keeper 2 on the same platform and the same account when the full game releases on September 22, 2026. Cross-platform carry-over is not supported, so the same platform + same account is required. The demo ran September 14-22, 2026 on Steam, PS5, PS4, Xbox Series X|S, Xbox One, Nintendo Switch, and Nintendo Switch 2, and was removed on launch day.",
  keyFacts: [
    { label: "Demo save carry-over", value: "Confirmed on same platform and account" },
    { label: "Demo window", value: "September 14-22, 2026" },
    { label: "Demo platforms", value: "Steam, PS5, PS4, Xbox Series X|S, Xbox One, Switch, Switch 2" },
    { label: "Carry-over requirement", value: "Same platform and same account; cross-platform not supported" },
  ],
  modules: [
    {
      id: "demo-save-carry-over",
      type: "prose",
      heading: "Do demo saves carry over to the full release?",
      body: "Yes. tinyBuild (publisher) and Lazy Bear Games (developer) confirmed across the September 22, 2026 launch-day press cycle that demo save files carry over into the full release. Players who played the demo during the September 14-22, 2026 window do not start over on launch day. Pixelsinorbit's launch coverage quotes tinyBuild directly: demo save files carry over into the full release, so anyone who played last week is not starting again today. Nettosgameroom lists DEMO PROGRESS CARRIES OVER AT LAUNCH as a launch feature, and 3dmgame frames it as confirmed across PS5, Xbox Series X|S, Switch 2, Switch, and Steam. The transfer is automatic once the full release goes live on September 22, 2026; no manual conversion or save export is needed.",
    },
    {
      id: "carry-over-requirements",
      type: "steps",
      heading: "Carry-over requirements and pre-launch handoff",
      items: [
        {
          title: "Stay on the same platform you played the demo on",
          body: "Demo saves carry over only to the same platform family (e.g., a Steam demo save carries over to Steam; a PS5 demo save carries over to PS5). Picking the right storefront on launch day is required for the carry-over to land.",
        },
        {
          title: "Use the same account the demo was tied to",
          body: "The carry-over is bound to the same account that owns the demo progress - Steam, PlayStation Network, Xbox, or Nintendo Account. Buying or booting the full release on a different account means starting a new playthrough.",
        },
        {
          title: "Force a manual save + cloud sync before the demo client is removed",
          body: "On PC, open the demo, save manually, then let Steam Cloud finish syncing the file before launch day. On console, make sure the most recent save is uploaded to that platform's cloud. The demo client is removed on September 22, 2026, so the cloud copy is the one the full release reads from.",
        },
        {
          title: "Install the full release on launch day and relaunch",
          body: "After installing the full release on the same platform with the same account, the demo save shows up automatically. Boot the game once so the carry-over handoff completes.",
        },
        {
          title: "Keep the same save type (single-player profile, not co-op or shared stash)",
          body: "The carry-over applies to your main save profile. If a co-op or shared-stash experiment exists from a special build, that profile is legacy and will not be the carry-over target.",
        },
      ],
    },
    {
      id: "what-transfers",
      type: "prose",
      heading: "What transfers from the demo to the full release",
      body: "Demo progress that carries over covers the opening chapter content: quest progress through The Town's opening section, inventory, crafting recipes unlocked, buildings placed, and any automation setups you wired up during the demo run. worldeka's transfer walkthrough treats the demo as a free head start on the production loop, not as a separate save slot. The pre-order bonus (Sauna building and Grand Inquisitor outfit) is granted by the pre-order, not by demo progress, and stacks on top of the carried-over save.",
    },
    {
      id: "achievement-caveat",
      type: "callout",
      tone: "caution",
      title: "Achievement flag caveat",
      body: "Achievements earned in the demo are flagged as demo unlocks on Steam. Once the full release launches, those achievements should re-flag or sync against the launch-day 38-achievement list, but a few demo-side flags can remain until a clean re-sync on the full-release client. If an achievement is still listed as a demo unlock after launch, boot the full release on the same account to let Steam re-sync the list.",
    },
    {
      id: "demo-scope",
      type: "prose",
      heading: "What the demo covered before it was removed",
      body: "The September 14-22, 2026 public demo let players play through the opening section of The Town. worldeka's transfer guide describes that scope as roughly three to four hours of main-chapter content covering early crafting, scavenging, grave-digging, decoration, and army management setups. That opening chapter scope is what carries over on launch day. Anything past the demo's chapter boundary is new territory once the full release unlocks.",
    },
    {
      id: "demo-platforms",
      type: "data-table",
      heading: "Demo platforms (September 14-22, 2026)",
      columns: [
        { key: "platform", label: "Platform" },
        { key: "family", label: "Carry-over to" },
      ],
      rows: [
        { platform: "Steam (Windows, macOS, Linux, SteamOS)", family: "Steam full release" },
        { platform: "PlayStation 5", family: "PS5 full release" },
        { platform: "PlayStation 4", family: "PS4 / PS5 full release" },
        { platform: "Xbox Series X|S", family: "Xbox Series X|S full release" },
        { platform: "Xbox One", family: "Xbox One / Xbox Series X|S full release" },
        { platform: "Nintendo Switch 1", family: "Switch 1 full release" },
        { platform: "Nintendo Switch 2", family: "Switch 2 full release" },
      ],
    },
    {
      id: "early-access-status",
      type: "prose",
      heading: "Does Graveyard Keeper 2 have a Steam Early Access phase?",
      body: "No. Graveyard Keeper 2 ships as a full launch on September 22, 2026. The Steam store page does not list an Early Access phase, and the console SKUs ship on the same day with no staggered pre-release window. The September 14-22, 2026 public demo is a free, time-limited trial, not a Steam Early Access program. The only Steam-side pre-launch offer was the 20% pre-purchase discount through launch day, which drops the $24.99 standard edition to $19.99.",
    },
    {
      id: "demo-removal",
      type: "callout",
      tone: "unknown",
      title: "What is not announced as of 2026-09-24",
      body: "A separate Epic Games Store or GOG.com demo build, a Steam Deck-verified demo build, cross-platform demo-to-full-release carry-over (PC to console or vice versa), and a guaranteed automated demo save sync versus a manual restore prompt on launch day.",
    },
  ],
  faqIds: ["early-access-status", "demo-save-carry-over"],
  relatedPageIds: ["fixed-release-platforms-en-US", "fixed-system-requirements-en-US", "fixed-editions-pricing-en-US"],
  schemaTypes: ["Article", "BreadcrumbList", "FAQPage"],
  sourceStatus: "official",
...
export const trophyAchievementsPage: PageContent = {
  ...
  pageType: "guides",
  presentation: { shell: "content", variant: "reading-right-rail" },
  h1: "Graveyard Keeper 2 Achievements: Full 38-Achievement List",
  seoTitle: "Graveyard Keeper 2 Achievements: Full List and Unlock Categories",
  metaDescription:
    "See the full launch-day Graveyard Keeper 2 achievement list: 38 Steam achievements split into 15 story, 18 progression, and 5 hidden trophies.",
  summary:
    "Graveyard Keeper 2 ships with 38 Steam achievements on launch day: 15 story beats, 18 progression milestones, and 5 hidden trophies that unlock silently.",
  hero: {
    eyebrow: "Achievement reference",
    subtitle: "38 launch-day achievements split across story, progression, and hidden categories.",
    ctas: [
      { label: "Gameplay length", href: "/gameplay-length/" },
      { label: "Cooking recipes", href: "/cooking/" },
    ],
  ...
  quickAnswer:
    "Graveyard Keeper 2 ships with 38 Steam achievements on launch day (September 22, 2026). They split into 15 story achievements that fire at quest milestones, 18 progression achievements that track grind and collection goals, and 5 hidden achievements whose names and unlock conditions stay blank until they trigger. The launch list is anchored to the Steam store page and a launch-day third-party Steam profile lookup for AppID 4358690.",
  keyFacts: [
    { label: "Total achievements", value: "38 (Steam launch day)" },
    { label: "Story achievements", value: "15" },
    { label: "Progression achievements", value: "18" },
    { label: "Hidden achievements", value: "5" },
  ],
  modules: [
    {
      id: "achievement-total",
      type: "prose",
      heading: "How many achievements does Graveyard Keeper 2 have?",
      body: "Graveyard Keeper 2 ships with 38 Steam achievements on launch day (September 22, 2026). The Steam store page for AppID 4358690 confirms the 38-achievement count on the public storefront, and a launch-day third-party Steam profile lookup enumerates 33 of them by name. The remaining 5 sit in the hidden tier, so Steam only reveals their names and unlock conditions after you trigger them. The 2018 original Graveyard Keeper's 126-trophy scope is a legacy reference, not a confirmed sequel target.",
    },
    {
      id: "story-achievements",
      type: "data-table",
      heading: "Story achievements (15)",
      columns: [
        { key: "name", label: "Achievement" },
        { key: "unlock", label: "Trigger" },
      ],
      rows: [
        { name: "A New Beginning", unlock: "Start the Inquisitor storyline" },
        { name: "Two Faces", unlock: "Story milestone" },
        { name: "A Man of Many Talents", unlock: "Story milestone" },
        { name: "A Little Magic", unlock: "Story milestone" },
        { name: "First Blood", unlock: "Story milestone" },
        { name: "Words of Faith", unlock: "Story milestone" },
        { name: "The Man Behind the Curtain", unlock: "Story milestone" },
        { name: "Back to Life", unlock: "Story milestone" },
        { name: "Open for Business", unlock: "Story milestone" },
        { name: "A New Dawn", unlock: "Story milestone" },
        { name: "Friends in Low Places", unlock: "Story milestone" },
        { name: "A Night to Remember", unlock: "Story milestone" },
        { name: "Forbidden Knowledge", unlock: "Story milestone" },
        { name: "The People Have Spoken", unlock: "Story milestone" },
        { name: "The End of the Journey", unlock: "Complete the main story" },
      ],
    },
    {
      id: "progression-achievements",
      type: "data-table",
      heading: "Progression achievements (18)",
      columns: [
        { key: "name", label: "Achievement" },
        { key: "unlock", label: "Unlock condition" },
      ],
      rows: [
        { name: "Bronze Age", unlock: "Smelt 100 bronze ingots" },
        { name: "Iron Age", unlock: "Smelt 100 iron ingots" },
        { name: "Supplier", unlock: "Deliver 50 supplies" },
        { name: "Merchants' Best Friend", unlock: "Complete 25 merchant orders" },
        { name: "Patron of Merchants", unlock: "Build 11 market stalls" },
        { name: "Urban Planner", unlock: "Build 15 houses" },
        { name: "Home Sweet Tomb", unlock: "Reach cemetery quality 200" },
        { name: "True Graveyard Keeper", unlock: "Process 50 corpses" },
        { name: "Master Cook", unlock: "Cook 100 dishes" },
        { name: "Necromancer", unlock: "Raise 50 zombies" },
        { name: "Master Farmer", unlock: "Harvest 100 crops" },
        { name: "Alcohol Baron", unlock: "Brew 100 bottles" },
        { name: "Shepherd of Souls", unlock: "Deliver 50 sermons" },
        { name: "Stroke of Genius", unlock: "Gain 150 inspirations" },
        { name: "Novice Alchemist", unlock: "Brew 25 potions" },
        { name: "Fish Magnet", unlock: "Catch 50 fish" },
        { name: "Tree Bane", unlock: "Chop 100 trees" },
        { name: "Warmaker", unlock: "Craft 50 battle items" },
      ],
    },
    {
      ...
      type: "callout",
      tone: "unknown",
      title: "5 hidden achievements",
      body: "Five achievements are flagged as hidden on launch day. Steam leaves their names and unlock conditions blank until you actually trigger them. Plan a blind playthrough if you want to discover them yourself, or expect spoilers once the community publishes triggers.",
    },
    {
      id: "console-parity",
      type: "prose",
      heading: "Console trophy parity (PS5, Xbox Series, Switch 1, Switch 2)",
      body: "PlayStation 5, Xbox Series, Nintendo Switch 1, and Nintendo Switch 2 trophy parity is not announced as of 2026-09-23. The Steam count and category split are public on the storefront, but the first-party console trophy lists have not been confirmed by Sony, Microsoft, or Nintendo. Until each console storefront publishes its own list, treat the 38-achievement Steam breakdown as the closest confirmed reference, not a guaranteed console scope.",
    },
    {
      id: "trophy-boundary",
      type: "callout",
      tone: "unknown",
      title: "What is not announced as of 2026-09-23",
      body: "Console (PS5, Xbox Series, Switch 1, Switch 2) trophy list, hidden achievement names, unlock conditions for the 5 hidden trophies, and per-platform trophy rarity weighting.",
    },
  ],
